...
export default function OrbitImages({
  ...
  const path = useMemo(() => {
    switch (shape) {
      case 'circle':
        return generateCirclePath(designCenterX, designCenterY, (radius || 300));
      case 'ellipse':
        return generateEllipsePath(designCenterX, designCenterY, (radiusX || 700), (radiusY || 170));
      case 'square':
        return generateSquarePath(designCenterX, designCenterY, (radius || 300) * 2);
      case 'rectangle':
        return generateRectanglePath(designCenterX, designCenterY, (radiusX || 700) * 2, (radiusY || 170) * 2);
      case 'triangle':
        return generateTrianglePath(designCenterX, designCenterY, (radius || 300) * 2);
      case 'star':
        return generateStarPath(designCenterX, designCenterY, (radius || 300), (radius || 300) * (starInnerRatio || 0.5), (starPoints || 5));
      case 'heart':
        return generateHeartPath(designCenterX, designCenterY, (radius || 300) * 2);
      case 'infinity':
        return generateInfinityPath(designCenterX, designCenterY, (radiusX || 700) * 2, (radiusY || 170) * 2);
      case 'wave':
        return generateWavePath(designCenterX, designCenterY, (radiusX || 700) * 2, (radiusY || 170), 3);
      case 'custom':
        return customPath || generateCirclePath(designCenterX, designCenterY, (radius || 300));
      default:
        return generateEllipsePath(designCenterX, designCenterY, (radiusX || 700), (radiusY || 170));
    }
