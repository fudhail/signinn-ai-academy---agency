...
export const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const refreshOffsets = useCallback(() => {
    ...
    // Perform bulk measurements outside of scroll loop
  ...
  useLayoutEffect(() => {
    ...
    // Second pass measurement after brief delay to ensure layout is settled
    const timeoutId = setTimeout(refreshOffsets, 100);
